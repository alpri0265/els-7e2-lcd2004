...
{  
   ...
   Start_Speed = ENC_LINE_PER_REV / ((uint32_t)MOTOR_Z_STEP_PER_REV * McSTEP_Z * MIN_FEED / SCREW_Z) / FEED_ACCEL /2 +0.5;
   if (Motor_Z_Pos < Limit_Pos_Left - Start_Speed * 2)
   {
      Feed_Divisor = ENC_LINE_PER_REV / ((uint32_t)MOTOR_Z_STEP_PER_REV * McSTEP_Z * Feed_mm / SCREW_Z) /2 +0.5;
...
void Cone_Ext_Left()
{
   ...
   else if (Motor_Z_Pos == Limit_Pos_Right && Motor_X_Pos == Limit_Pos_Front && Step_X_flag == OFF && q != 6)
   {
   ...
   else if (Motor_Z_Pos == Limit_Pos_Left && q == 1)
   {
    ...
    q = 2;
      ...
      else if (Motor_Z_Pos == Limit_Pos_Left && Motor_X_Pos == Limit_Pos_Front && q == 2)
   {
      cycle_flag = false;
      a_flag = false;
      b_flag = false;
      ...
      else if (Motor_Z_Pos == Limit_Pos_Left && q == 3 && Motor_X_Pos == Limit_Pos_Rear && Step_X_flag == OFF)
   {
      ...
      else if (Motor_Z_Pos == Limit_Pos_Right && q == 5 && Motor_X_Pos == Limit_Pos_Rear && Step_Z_flag == OFF)
   {
