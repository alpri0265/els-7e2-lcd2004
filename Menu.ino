   ...
   {  
      switch (Mode) 
      {
         case Mode_Feed:
            ...
            else if (SelectMenu == 1) SelectMenu = 0;           
            Beep();          
         break;
         ...
         case Mode_aFeed:
            ...
            else if (SelectMenu == 2) {SelectMenu = 0;}            
            Beep();   
         break;
...
void Key_Up_Pressed()
{
  if (!button_up_flag)
  {
     ...
     {
        case Mode_Feed:
        if (SelectMenu == 0 && !Joy_Z_flag && !Joy_X_flag)
        {
        ...
        if (SelectMenu == 0 && !Joy_Z_flag && !Joy_X_flag)
           ...
           else if (SelectMenu == 1 && Total_Tooth < 255 && !Joy_Z_flag && !Joy_X_flag)
           {
           Total_Tooth++;
           Current_Tooth = 1;
           Beep();
        ...
        case Mode_Thread:
        if (Thread_Step < TOTAL_THREADS - 1 && SelectMenu == 0)
        {
           if (!Joy_Z_flag && !Joy_X_flag)
           {
              Thread_Step++;
        ...
        case Mode_Sphere:
           ...
           else if (SelectMenu == 1 && !Joy_Z_flag && !Joy_X_flag)
           {
   ...
   if (!button_down_flag)
   {
      switch (Mode)
      {
         ...
         if (SelectMenu == 0 && !Joy_Z_flag && !Joy_X_flag)
            ...
            else if (SelectMenu == 1 && Total_Tooth > 1 && !Joy_Z_flag && !Joy_X_flag)
            {
            Total_Tooth--;
            Current_Tooth = 1;
            Beep();
...
void Key_Left_Pressed()
{
   if (!button_left_flag)
   {
      ...
      {
         case Mode_Feed:
         if (SelectMenu == 0 && Pass_Total > 1 && !Joy_Z_flag && !Joy_X_flag)
            {
               Pass_Total--;
               Beep();
            }
         ...
         else if (SelectMenu == 1 && Cone_Step > 0 && !Joy_Z_flag && !Joy_X_flag)
         {
               Cone_Step--;
               Ks_Count = 0;
               Km_Count = 0;
         ...
         case Mode_Thread:
         if (Pass_Fin > 0 && SelectMenu == 1 && !Joy_Z_flag && !Joy_X_flag)
            {
               Pass_Fin --;
               Beep();
            }
         else if (SelectMenu == 0 && (Thread_Info[Thread_Step].Pass + Thr_Pass_Summ) > 2 && !Joy_Z_flag && !Joy_X_flag)
            {
               Thr_Pass_Summ --;
               Beep();
            }
...
void Key_Right_Pressed()
{
   if (!button_right_flag)
   {
      ...
      {
         case Mode_Feed:
         if (SelectMenu == 0 && Pass_Total < 99 && !Joy_Z_flag && !Joy_X_flag)
            {
               Pass_Total++;
               Beep();
            }
         ...
         case Mode_aFeed:
         if (Pass_Total < 99 && SelectMenu == 0 && !Joy_Z_flag && !Joy_X_flag)
         {
               Pass_Total++;
               Beep();
         }
         ...
         else if (SelectMenu == 1 && Cone_Step < TOTAL_CONE - 1 && !Joy_Z_flag && !Joy_X_flag)
         {
          Cone_Step++;
          Ks_Count = 0;
          Km_Count = 0;
         ...
         case Mode_Thread:
         if (Pass_Fin < 9 && SelectMenu == 1 && !Joy_Z_flag && !Joy_X_flag)
            {
               Pass_Fin ++;
               Beep();
            }
         else if (SelectMenu == 0 && Thread_Info[Thread_Step].Pass + PASS_FINISH + Thr_Pass_Summ < 90 && !Joy_Z_flag && !Joy_X_flag)
            {
               Thr_Pass_Summ ++;
               Beep();
            } 
